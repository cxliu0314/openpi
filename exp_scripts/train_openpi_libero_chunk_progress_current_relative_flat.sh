...
EXP_NAME="${EXP_NAME:-pi05_libero_lora_chunk_progress_current_relative_flat}"
...
PROGRESS_READOUT_MODE="chunk_current_relative_flat"
PROGRESS_INPUT="current(prefix_final_pooled+clean_action_summary), relative(future_low_noise_suffix_tokens)"
PROGRESS_HEAD_ARCH="current: prefix2048->192 + action_summary128 -> 256 -> 128 -> 1; relative: 288 -> 192 -> 96 -> 1"

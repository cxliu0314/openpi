...
CONFIG_NAME="${CONFIG_NAME:-pi05_rlds_modified_libero_uni_no_progress}"
EXP_NAME="${EXP_NAME:-pi05-rlds-libero-full-ori-$(date -u +%Y%m%d_%H%M%S)}"
...
echo "============================================"
echo "  OpenPI pi0.5 full finetune: modified LIBERO RLDS"
echo "============================================"
...
echo "========== Train pi0.5 full finetune without progress head =========="

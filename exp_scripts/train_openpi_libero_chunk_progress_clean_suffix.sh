...
EXP_NAME="pi05_libero_lora_chunk_progress_clean_suffix"
...
PROGRESS_READOUT_MODE="chunk_low_noise_action"
PROGRESS_INPUT="low_noise_suffix_tokens"
PROGRESS_HEAD_ADAPTER_DIMS="1024->1024"

...
EXP_NAME="pi05_libero_lora_chunk_progress_hybrid_concat"
...
PROGRESS_READOUT_MODE="chunk_hybrid_concat"
PROGRESS_INPUT="concat(pooled_prefix_hidden,image+prompt;low_noise_suffix_tokens)"
PROGRESS_HEAD_ADAPTER_DIMS="3072->1024"
PROGRESS_HEAD_MLP_DIMS="1024->512->128->1"
...
echo "Progress adapter dims:   $PROGRESS_HEAD_ADAPTER_DIMS"
echo "Progress head dims:      $PROGRESS_HEAD_MLP_DIMS"
